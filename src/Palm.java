...
public class Palm extends Plantor{
    ...
    private PlantEnum vatten = PlantEnum.KRANVATTEN;          //vatten variabel sätts / initieras till PlantEnum.Kranvatten, alltså konstanten KRANVATTEN. this.vatten.vattenTyp ger kranvatten i små bokstäver (från strängvariabeln vattentyp i enum)
